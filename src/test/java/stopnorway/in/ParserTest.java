...
class ParserTest extends ParserTestCase {
    ...
    public void serviceLinksFlaambanen() {
        ...
        assertThat(run.getJourneySpecifications(surroundingBox)).hasSizeGreaterThan(11);

        Point flaamStasjon = point(60.86307, 7.11378);

        assertThat(run.getJourneySpecifications(flaamStasjon.scaledBox(Scale.DEFAULT))).hasSizeGreaterThan(11);
